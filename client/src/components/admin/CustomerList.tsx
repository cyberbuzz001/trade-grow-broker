...
import { Search, Filter, Download, Eye, Lock, Unlock, KeyRound, X, Check, Copy, RefreshCw, CheckCircle2, AlertTriangle, UserPlus, ShieldAlert, Users, Phone, Mail, User, DollarSign, Shield } from 'lucide-react';
            ...
            {customers.map(c => {
              ...
              return (
                <tr key={c.id} className="hover:bg-slate-800/40 transition">
                  ...
                  <td className="py-2.5 px-3.5 text-center flex items-center justify-center gap-1.5">
                    <button 
